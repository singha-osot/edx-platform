...
class LearnAIOAuth2(BaseOAuth2):
    name = 'learn-ai'
    ID_KEY = 'username'
    AUTHORIZATION_URL = 'http://learn-ai.in.th/oauth2/authorize'
    ACCESS_TOKEN_URL = 'http://learn-ai.in.th/oauth2/access_token'
    ...
    def user_data(self, access_token, *args, **kwargs):
        url = 'http://learn-ai.in.th/api/user/v1/accounts'
